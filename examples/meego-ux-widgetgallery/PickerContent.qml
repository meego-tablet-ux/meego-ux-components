...
//            property int cellWidth: ( width - 3 * space ) / 2
//            property int cellHeight: ( height - ( buttonModel.count + 1 ) * space ) / buttonModel.count
...
//            width:  parent.width * 0.75
        ...
        function showPage ( type ){
            ...
            ListModel {
                ...
                ListElement {
                    listIcon: "image://themedimage/camera/camera_lens_sm_up"
                    listIconDown: "image://themedimage/camera/camera_lens_sm_dn"
                    pickerType: "photo"
