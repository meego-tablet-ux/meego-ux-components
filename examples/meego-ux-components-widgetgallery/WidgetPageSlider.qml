...
/* This pages shows the Slider.qml and offers controls to manipulate it.
 */
...
WidgetPage {
    ...
    description: "This is a slider with customizable size and value ranges and options to set the current value. \n"
